...
with row2[0]:
    ...
    background-color: black; border:2px solid grey; border-radius:3px; z-index:9999; font-size:14px; padding: 20px;
    ...
    height: 20px; display: inline-block; margin-right: 5px;"></i> < 10 <i style="background:yellow; width: 20px; 
